...
import NewsIdLatestNews from "./NewsIdLatestNews";
import Context from "../Context";
import { useDispatch, useSelector } from "react-redux";
import moment from "moment";
import { updateViews } from "../api";
import { UPDATE_BEST_VIEWS, UPDATE_VIEWS } from "../redux/action";
...
export default function BestNewWithId({ data }) {
